class CListInfo extends CList
{
   ...
   function Initialize(sRowClassName, sSelectedRowClassname, iListSize)
   {
      ...
      while(_loc3_ < iListSize - 1)
      {
         ...
         _loc2_.AddEventListener(this,mh2lib.utils.MH2Event.MOUSE_PRESS,this.SelectOption);
         _loc3_ = _loc3_ + 1;
      }
      ...
      _loc2_.AddEventListener(this,mh2lib.utils.MH2Event.MOUSE_ROLL_OVER,this.RowRollOverSelected);
      _loc2_.AddEventListener(this,mh2lib.utils.MH2Event.MOUSE_ROLL_OUT,this.RowRollOutSelected);
      _loc2_.AddEventListener(this,mh2lib.utils.MH2Event.MOUSE_PRESS,this.CallbackClicks);
   ...
   function AttachData(pRow, pData)
   {
      ...
      if(pData.Head == true)
      {
         ...
         if(pRow.m_tfName != undefined)
         {
            ...
            _loc4_ = !pData.Name ? "" : String(flash.external.ExternalInterface.call("StringToUpper",pData.Name));
   ...
   function CallbackClicks(e)
   {
      ...
      {
         var _loc2_ = getTimer();
         if(_loc2_ - this.m_iLastClick < CSlot.DOUBLE_CLICK_DELAY)
         {
            trace("m_pOnDoubleClickCallBack ");
            this.m_pOnDoubleClickCallBack(this);
            this.m_iLastClick = _loc2_ - CSlot.DOUBLE_CLICK_DELAY - 10;
         }
         else
         {
            trace("m_pOnPressCallBack ");
            this.m_pOnPressCallBack(this);
            this.m_iLastClick = _loc2_;
         }
      }
      else
      {
   ...
   function SelectTracked()
   {
      ...
      var _loc2_ = 0;
      while(_loc2_ < this.m_aItemsData.length)
      {
         _loc3_ = this.m_aItemsData[_loc2_];
         if(_loc3_.State == "T")
         {
            _loc4_ = _loc2_;
            break;
